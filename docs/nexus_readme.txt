...
[list=1]
[*] [b]Install the latest version of [url=https://smapi.io/]SMAPI[/url].[/b]
[*] [b]Download Rented Tools Refresh[/b] from [url=https://github.com/chronohart/RentedToolsRefresh/releases]the Releases page on GitHub[/url] or [url=https://www.nexusmods.com/stardewvalley/mods/29611/]the mod page on NexusMods[/url].
[*] [b]Unzip RentedToolsRefresh.zip[/b] into the [b]Stardew Valley\Mods[/b] folder.
[/list]
...
[list=1]
[*] [b]Run the game[/b] using SMAPI. This will generate the mod's [b]config.json[/b] file in the [b]Stardew Valley\Mods\RentedToolsRefresh[/b] folder.
